...
infereceData       <- read.table("/home/javad/Desktop/Serrano/serrano/data/Output_Data/KNN/inferenceData.txt")
...
inferenceData <- infereceData[,2]


plot(index,original_signal_0, pch=16, xlab="index", ylim=c(-120,120), ylab=" signal ", type="l", col="red", main="KNN Classification")

lines(index,original_signal_0, pch=16,  "l", col="blue")
lines(index,original_signal_1, pch=16,  "l", col="blue")
lines(index,original_signal_2, pch=16,  "l", col="blue")
lines(index,original_signal_3, pch=16,  "l", col="blue")
lines(index,original_signal_4, pch=16,  "l", col="blue")
lines(index,original_signal_5, pch=16,  "l", col="blue")
lines(index,original_signal_6, pch=16,  "l", col="blue")
lines(index,original_signal_7, pch=16,  "l", col="blue")
lines(index,original_signal_8, pch=16,  "l", col="blue")
lines(index,original_signal_9, pch=16,  "l", col="blue")
lines(index,original_signal_10, pch=16,  "l", col="blue")
lines(index,original_signal_11, pch=16,  "l", col="blue")
lines(index,original_signal_12, pch=16,  "l", col="blue")
lines(index,original_signal_13, pch=16,  "l", col="blue")
lines(index,original_signal_14, pch=16,  "l", col="blue")
lines(index,original_signal_15, pch=16,  "l", col="red")
lines(index,original_signal_16, pch=16,  "l", col="red")
lines(index,original_signal_17, pch=16,  "l", col="blue")
lines(index,original_signal_18, pch=16,  "l", col="blue")
lines(index,original_signal_19, pch=16,  "l", col="blue")
lines(index,original_signal_20, pch=16,  "l", col="blue")
lines(index,original_signal_21, pch=16,  "l", col="red")
lines(index,inferenceData, pch=16,  "l", col="blue")
