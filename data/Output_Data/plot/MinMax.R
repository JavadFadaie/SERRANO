...
filtered_signal_1 <- read.table("/home/javad/Desktop/Serrano/serrano/data/Output_Data/MinMax/signal_filter_0.txt")
...
plot(index,original_signal_0, pch=16, xlab="index", ylab=" signal ", type="l", col="blue", main="Min Max Transformation")
